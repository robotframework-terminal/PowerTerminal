...
setup(
    name="PowerTerminal",
    version=find_version("src/PowerTerminal", "__init__.py"),
    package_dir={"": "src"},
    packages=["PowerTerminal"],
    url="https://github.com/robotframework-terminal/PowerTerminal",
    author="Abhisit Sangjan",
    author_email="abhisit.sangjan@gmail.com",
    description="The Robot Framework Keywords to control Power Distribution Units (PDU)",
    ...
    keywords="robotframework terminal testing telnet ssh pdu mqtt restful",
